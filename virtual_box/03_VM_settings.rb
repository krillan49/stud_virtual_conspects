...
# Снимки - находятся рядом с "Детали" в настройках ВМ, если нажать, то будет список сохраненных состояний ВМ со всем что в ней есть. Каждый снимок это разница межу предыдущим и следую.щем состоянием. Требует места на жестком диске 

# 1я кнопка в меню снимков сделает новый снимок. Позволяет откатится на эти версии ВМ если что-то пошло не так
